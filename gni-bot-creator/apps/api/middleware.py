...
API_RATE_LIMIT_PER_MINUTE = env_int("API_RATE_LIMIT_PER_MINUTE", 60, min_value=1)
API_RATE_LIMIT_PER_HOUR = env_int("API_RATE_LIMIT_PER_HOUR", 1000, min_value=1)
API_MAX_BODY_SIZE = env_int("API_MAX_BODY_SIZE", 65536, min_value=1)  # 64KB
